/***************************************************************************************
 *   Proyecto: timer0-phasecorrectpwm-m16
 * 
 *      Archivo:  ejemplo1.c
 ...
 *  Descripción:
 *
 *      Este ejemplo usa el timer0 para generar una señal PWM con correción de fase
 *      por el pin OC0 ().
 *      
 ...
 *    Copyright:
 *
 *        Copyrigth© 2017 Alfredo Orozco - www.vidaembebida.wordpress.com
...
void InitSystem()
{
    ...
    // WGM00 = 1 : Modo Phase Correct PWM.
